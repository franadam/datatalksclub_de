...
```sql
SELECT count(filename) FROM de_zoomcamp.yellow_tripdata WHERE filename LIKE '%2020%'
```
...
```sql
SELECT count(filename) FROM de_zoomcamp.yellow_tripdata WHERE filename LIKE '%2020-03%'
```
